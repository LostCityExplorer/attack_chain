...
def main():
    # 设置命令行参数解析
    parser = argparse.ArgumentParser(description='Compute Jaccard Index between two files.')
    parser.add_argument('file0', type=str, help='Path to the first file')
    parser.add_argument('file1', type=str, help='Path to the second file')
    
    # 解析命令行参数
    args = parser.parse_args()
    
    # 调用Jaccard_index函数并打印结果
    result = Jaccard_index((args.file0, args.file1))
