...
def plot_whole_and_part (FileName):
    ...
    fig, [ax0, ax1] = plt.subplots(1, 2, figsize=(3.5,2), dpi=600, facecolor='w')
    ...
    # 设置刻度位置
    tick_locs = [0, 1.15, 2, 2.9, 4]  # 0和4放在开端和末端，其他刻度放在中间
    ...
    plt.tight_layout()
    plt.savefig("exit.pdf", dpi=300, bbox_inches="tight")
